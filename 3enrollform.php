...
<html>
    ...
    <div id="sidebar" style="margin-left : 94px; width : 180px; height : auto; margin-top: 120px;" >
            <ul>
                ...
                <li style="text-decoration : underline; color : black; font-size : 1rem;"><b>3학년</b></li>
                <li><a style="text-decoration : none; color : black; font-size : 1rem;" href="http://125.141.139.75/4enrollform.php">방과후</a></li>
            </ul>
        </div>
        ...
        <option><?=$row['name']?></option>
             ...
             ?>
                ...
                <input style="margin-left : 10px;" type="submit" value="신청하기" name="submit"/>
                    ...
                    <h1>수강신청 취소</h1>
                    <form action="enrolcancel.php" method = "post" enctype="multipart/form-data" id="sss">
    <fieldset style="margin-top : 1rem;" >
